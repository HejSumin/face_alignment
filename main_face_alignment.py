...
I_grayscale_matrix, S_hat_matrix, S_delta_matrix, S_true_matrix = fa.prepare_training_data(t_data)
...
start = timer()
S_hat_matrix = fa.train_single_cascade(I_grayscale_matrix, S_hat_matrix, S_delta_matrix) 
end = timer()
print(S_hat_matrix)
