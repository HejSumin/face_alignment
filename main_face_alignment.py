...
start = timer()
training_data_result, model_complete_regression_trees= fa.train_multiple_cascades(training_data)
end = timer()

np.save("run_output/run_output_numpy_training_data_result", training_data_result)
np.save("run_output/model_complete_regression_trees", model_complete_regression_trees)
