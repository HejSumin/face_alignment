...
def select_best_candidate_split_for_node():
    return
...
def generate_candidate_splits(current_node_id, current_depth, max_depth):  
    ...
    return (generate_candidate_splits(left.id, current_depth+1, max_depth), generate_candidate_splits(right.id, current_depth+1, max_depth))

tree = Tree()
root = generate_root(tree)
generate_candidate_splits(current_node_id=root.id, current_depth=0, max_depth=2)
